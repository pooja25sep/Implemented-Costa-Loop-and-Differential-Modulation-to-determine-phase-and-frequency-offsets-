...
class psk8_dm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "psk8_dm")
        ...
        self.variable_constellation_bpsk = variable_constellation_bpsk = digital.constellation_calcdist(Bpsk, [0,1],
        2, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.variable_constellation_8_psk = variable_constellation_8_psk = digital.constellation_calcdist(eight_psk, [0, 1 ,2 ,3 ,4 ,5 ,6 , 7],
        ...
        self.phase_slider = phase_slider = 1
        ...
        self._phase_slider_range = Range(0, 10, 0.1, 1, 200)
        ...
        self._freq_slider_range = Range(0, 100, 1, 0, 200)
        ...
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(variable_constellation_qpsk)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\YASH\\Desktop\\Mtech stuff\\placement\\projects\\final projects\\costa loop and DM\\pooja\\output_8psk_dm.txt', False)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate_iq, analog.GR_COS_WAVE, 500000, 1, 0, (phase_slider*((2*pi)/3)))
        ...
        self.connect((self.fir_filter_xxx_0_0, 0), (self.blocks_complex_to_imag_0, 0))
        self.connect((self.fir_filter_xxx_0_0, 0), (self.blocks_complex_to_real_1, 0))
    ...
    def set_variable_constellation_qpsk(self, variable_constellation_qpsk):
        ...
        self.digital_constellation_decoder_cb_0.set_constellation(self.variable_constellation_qpsk)

    def get_variable_constellation_bpsk(self):
        return self.variable_constellation_bpsk

    def set_variable_constellation_bpsk(self, variable_constellation_bpsk):
        self.variable_constellation_bpsk = variable_constellation_bpsk

    def get_variable_constellation_8_psk(self):
        return self.variable_constellation_8_psk

    def set_variable_constellation_8_psk(self, variable_constellation_8_psk):
        self.variable_constellation_8_psk = variable_constellation_8_psk
    ...
    def set_phase_slider(self, phase_slider):
        ...
        self.analog_sig_source_x_0_0.set_phase((self.phase_slider*((2*pi)/3)))
...
def main(top_block_cls=psk8_dm, options=None):
