...
class costa_loop(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\YASH\\Desktop\\Mtech stuff\\placement\\projects\\final projects\\costa loop and DM\\pooja\\output_costa.txt', False)
